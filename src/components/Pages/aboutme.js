...
import image1 from './seattle.JPG'
import image2 from './grad_photo.JPG'
import image3 from './kona_chain.JPG'
import image4 from './skiing.jpeg'
import image5 from './Me_and_my_dog.JPG'
...
export default function aboutme() {
    ...
    <img  src={image1} alt="Seattle Sunset" className="image"></img>
    ...
    <div className="cards__item">
    <img src={image2} alt="Graduation Photo" className="image"></img>
    ...
    <div className="cards__item">
    <img src={image3} alt="Pug wearing a chain" className="image"></img>
    ...
    <div className="cards__item">
    <img src={image4} alt="View from the ski lift" className="image" ></img>
    ...
    <br></br>
    <div className="cards__item">
    <img src={image5} alt="View from the ski lift" className="image"></img>
